                        ...
                        (t.WaveShaper = function (t, e) {
                            ;(this._shaper = this.input = this.output = this.context.createWaveShaper()),
                                ...
                                Array.isArray(t)
                                    ...
                                    : this.isFunction(t) &&
                                      ((this._curve = new Float32Array(this.defaultArg(e, 1024))), this.setMap(t))
                        }),
                ...
                (r = function (i) {
                    return (
                            ...
                            tr: {
                                ...
                                method: function (t, e, n) {
                                    ...
                                    return (
                                        t &&
                                            '0' !== t &&
                                            (i += this._beatsToUnits(this._timeSignature() * parseFloat(t))),
                        ...
                        (i.TimeBase.prototype._parseUnary = function (t) {
                            ...
                            return i
                                ? ((e = t.next()), (n = this._parseUnary(t)), i.method.bind(this, n))
        ...
        ;(a = []),
            'function' != typeof AudioWorkletNode &&
                ((self.AudioWorkletNode = function (t, e, n) {
                    ...
                    return (
                        (p = null), (r.port = u.port1), (r.processor = i), (r.instance = c), (r.onaudioprocess = l), r
                    )
                }),
                        ...
                        (u.Expr.prototype._parseTree = function (t) {
                            ...
                            function a(t) {
                                            ...
                                            ? (function t() {
                                                  ...
                                                  return o((e = i.peek()), 'unary')
                                                      ...
                                                      : (function () {
                                                            ...
                                                            if ('value' === t.type)
                                                                return { method: (t = i.next()).method, args: t.value }
                                                            if (r(t, '(')) {
                                ...
                                for (var n = i.peek(); o(n, 'binary', t); )
                                    (e = { operator: (n = i.next()).value, method: n.method, args: [e, a(t - 1)] }),
                                        (n = i.peek())
                                return e
                            }
                            return a()
                                ...
                                ;(t.onload = function () {
                                    r.panner &&
                                        R.decodeAudioData(t.result, function (t) {
                                            r.panner &&
                                                ((r.buffer = t), r.panner.inputChannels(t.numberOfChannels), n && n(r))
                                        })
                                }),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            var n = t || 0,
                                i = e || void 0
                            this.isPlaying() &&
                                (this.stop(0), this.play(0, this.playbackRate, this.output.gain.value, n, i))
                        },
                    },
                    {
                        key: 'channels',
                    ...
                    (function (t, e, n) {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.output && this.output.disconnect(),
                                    this.panner &&
                                        (this.panner.disconnect(), this.output && this.output.connect(this.panner)),
                                    (this.oscMods = [])
                            },
                        },
                        {
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if (t.isPlaying) {
                                ...
                                t.clock.start(i + n), (t.isPlaying = !0), this.clock.start(i + n), (this.isPlaying = !0)
                        },
                    },
                    {
                        key: '_update',
                            ...
                            if (t) {
                                ...
                                if (this.notes[o] && null !== this.notes[o].getValueAtTime(r)) {
                                    ...
                                    this._voicesInUse.setValueAtTime(s - 1, r),
                                        ...
                                        delete this.notes[o],
                                        (this._newest =
                                            0 === this._newest ? 0 : (this._newest - 1) % (this.maxVoices - 1))
                                } else;
                            } else
